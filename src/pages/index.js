  ...
  return (
    <main style={pageStyles}>
      ...
      <div className="flex flex-col">
        <div className="h-16 bg-gradient-to-r from-red-400 rounded-full flex items-center justify-center">
          elem1
        </div>
        <div className="md:rounded-lg h-24 w-24 bg-purple-500">elem2</div>
        <div>elem3</div>
      </div>
    </main>
  );
